...
import { applyCoupon, createCoupon, deleteCoupon, getAllCoupon, getCouponById, removeCoupon, updateCoupon } from "../controllers/couponController.js";
...
router.delete("/remove", verifyJWT, authorizeRoles(ROLES.CUSTOMER), removeCoupon);
